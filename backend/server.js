...
// Infoway handles all asset classes: Forex, Crypto, Stocks, Metals, Energy
...
// Serve APK download
app.get('/downloads/Vediex.apk', (req, res) => {
  const apkPath = path.join(__dirname, 'apk', 'Vediex.apk')
  res.download(apkPath, 'Vediex.apk', (err) => {
    if (err) {
