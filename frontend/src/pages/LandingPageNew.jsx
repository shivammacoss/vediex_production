...
const PropFunding = () => {
  ...
  return (
    <section id="prop-funding" className="relative py-24 sm:py-32 bg-[#0B0D17]">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div ref={ref} initial="hidden" animate={controls} variants={staggerContainer} className="text-center">
          ...
          <motion.p variants={fadeUp} className="text-lg text-[#8892B0] max-w-2xl mx-auto mb-8">
            Choose your challenge type and account size. Prove your trading skills and get funded with our capital.
          </motion.p>

          {/* Features Grid */}
          <motion.div variants={fadeUp} className="grid sm:grid-cols-3 gap-6 mb-10 max-w-4xl mx-auto">
            {[
              { title: 'Instant Fund', desc: 'Skip evaluation, get funded immediately', icon: '⚡' },
              { title: 'One Step', desc: 'Pass one phase to get funded', icon: '1️⃣' },
              { title: 'Two Step', desc: 'Higher profit split with two phases', icon: '2️⃣' },
            ].map((item) => (
              <div key={item.title} className="rounded-2xl bg-[#1A1D35] border border-[rgba(108,92,231,0.15)] p-6 text-center">
          ...
          {/* How It Works */}
          <motion.div variants={fadeUp} className="rounded-2xl bg-[#1A1D35] border border-[rgba(108,92,231,0.15)] p-8 mb-10 max-w-4xl mx-auto">
            <h3 className="text-white font-bold text-xl mb-6">How It Works</h3>
            <div className="grid sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={step.num} className="text-center">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center mx-auto mb-3" style={{ backgroundColor: step.color }}>
          ...
          <motion.div variants={fadeUp}>
            <a
              href="/prop-funding"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-semibold bg-[#6C5CE7] hover:bg-[#5B4BD5] text-white transition-all duration-200 text-lg"
            >
              <Trophy size={20} />
              View All Challenges
          ...
          <motion.p variants={fadeUp} className="text-sm text-[#8892B0]/60 mt-8">
            * Up to 80% profit split. Challenge rules may vary.
          </motion.p>
        </motion.div>
      </div>
    </section>
